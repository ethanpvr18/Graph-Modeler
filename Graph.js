...
export class Graph {
    ...
    constructor() {
        ...
        this.SelectionArea = class {
            ...
            open(x=0, y=0) {
                ...
                this.selectionArea.style.right = `${x}px`;
        ...
        this.Vertex = class {
            ...
            getVertex(label) {
                return graph.vertices.filter(v => v.vertex.label === label);
            }
    ...
    async openGraph() {
        ...
        try {
            ...
            graph.edges.forEach(edge => new graph.Edge(this.vertices[edge.v1Index], this.vertices[edge.v2Index], edge.weight));
